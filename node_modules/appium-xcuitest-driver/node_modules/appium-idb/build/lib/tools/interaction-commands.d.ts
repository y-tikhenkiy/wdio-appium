...
declare namespace interactionCommands {
     ...
     */
    function tap(this: import("../idb.js").default, x: string | number, y: string | number): Promise<void>;
    /**
     ...
     */
    function pressKeycode(this: import("../idb.js").default, codeOrCodes: string | number | string[] | number[], opts?: KeycodeOpts): Promise<void>;
}
